...
public class MilkFileDAOTest {
    ...
    public void setupMilkFileDAO() throws IOException
    {
        ...
        testMilks[0] = new Milk(10, "cow", "banana", 2.5, 8, 2.95, rating,"../assets/images/glass-o-milk.jpg");
        testMilks[1] = new Milk(11, "oat", "chocolate", 4.2, 5, 4.50, rating, "../assets/images/glass-o-milk.jpg");
        testMilks[2] = new Milk(12, "goat", "strawberry", 3.9, 11, 4.23, rating, "../assets/images/glass-o-milk.jpg");
        testMilks[3] = new Milk(13, "almond", "pumpkin", 5.7, 14, 6.03, rating, "../assets/images/glass-o-milk.jpg");
    ...
    public void testCreateMilk()
    {
        // Setup
        double[] rating = {4.0};
        Milk milk = new Milk(14, "almond", null, 2.5, 8, 3, rating, "../assets/images/glass-o-milk.jpg");
        // Invoke
    ...
    public void testUpdateMilk()
    {
        ...
        Milk milk = new Milk(10, "coconut", "wheat", 5.9, 2, 7.3, rating, "../assets/images/glass-o-milk.jpg");
